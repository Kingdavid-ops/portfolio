...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[var(--shadow-glow)] hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]",
        gold:
          "bg-gold text-gold-foreground shadow-[var(--shadow-gold)] hover:brightness-110 hover:scale-[1.02]",
        outline:
          "border border-border bg-transparent hover:bg-muted hover:border-primary/50",
        ghost: "hover:bg-muted hover:text-foreground",
        glass:
          "glass text-foreground hover:border-primary/40 hover:shadow-[var(--shadow-glow)]",
